-- Global speed multiplier: 1.0 = as designed, <1 faster, >1 slower
local duration_scale = 1.3

local prod = function(ds)
    return ds * duration_scale
end
...
hl.animation({leaf = "workspacesIn", enabled = true, speed = prod(4.0), bezier = "menu_decel", style = "slidevert"})
hl.animation({leaf = "workspacesOut", enabled = true, speed = prod(4.0), bezier = "menu_decel", style = "slidevert"})
hl.animation(
...
hl.animation({leaf = "borderangle", enabled = false, speed = prod(82), bezier = "liner", style = "loop"})
hl.animation({leaf = "windowsIn", enabled = true, speed = prod(3.8), bezier = "winIn", style = "slide"})
hl.animation({leaf = "windowsOut", enabled = true, speed = prod(2.7), bezier = "winOut"})
...
hl.animation({leaf = "workspaces", enabled = true, speed = prod(4.0), bezier = "menu_decel", style = "slidevert"})
hl.animation(
